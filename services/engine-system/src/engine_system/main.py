...
from .worker import SystemWorker
...
async def lifespan(app: FastAPI):
    ...
    engine = SystemEngine(redis_client=redis_client)
    storage = SystemStorage(redis_client=redis_client, clickhouse_client=ch_client)
    worker = SystemWorker(engine=engine, storage=storage)
